...
class ipify:
    ...
    def get_address(self, format: str = 'json', callback: str = None) -> requests.Response:
        __address__ = (
            f"{self.api_uri}"
    ...
    @staticmethod
    def get_ipv4(format: str = 'json', callback: str = None) -> requests.Response:
        __address__ = (
    ...
    @staticmethod
    def get_ipv6(format: str = 'json', callback: str = None) -> requests.Response:
        __address__ = (
    ...
    @staticmethod
    def get_ipv64(format: str = 'json', callback: str = None) -> requests.Response:
        __address__ = (

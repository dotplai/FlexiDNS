...
class NoIP:
    ...
    def A(self, hostname: str, address: str) -> dict:
        """
        ...
        try:
            ...
            __logger__.__logging__(f"Updated hostname '{hostname}' to IP '{ip_address}' successfully.", level=20)
            return {"status": "success", "response": response.text}
        except requests.exceptions.RequestException as e:
            __logger__.__logging__(f"Failed to update hostname '{hostname}': {str(e)}", level=40)
